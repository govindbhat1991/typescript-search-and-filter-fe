...
// export interface BindingPropertyValue<T> {
//     bindingKey: string;
//     value: T;
// }

// export enum BindingPropertyNameEnum {
//     Class = 'class',
//     Style = 'style',
//     Attr = 'attr',
// }

// export interface BindingPropertyName {
//     [BindingPropertyNameEnum.Class]?: BindingPropertyValue<string>[];
//     [BindingPropertyNameEnum.Style]?: BindingPropertyValue<string | number>[];
//     [BindingPropertyNameEnum.Attr]?: BindingPropertyValue<string | boolean>[];
// }
